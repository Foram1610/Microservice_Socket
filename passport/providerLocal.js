...
module.exports = new LocalStrategy({
		...
		try{
			...
			let userDetails = await User.findOne({ email: email,userType:{$in:['COMPANY','INDIVIDUAL']} }).select('_id name profileImage assignedCompanyId status email hashPassword isBlocked isDeleted mobileNumber countryCode deviceType userType accountStatus,uniqueId companyName commercialRegNo idNumber')
