...
const data = [
    {
        ...
        cityId: ["60379a846a48d26ed3c2bebb"]
    },
    {
        page: 1,
...
describe("Test the get District for blocked category API", () => {


    it("It should response 200 to the POST method", async () => {

        const response = await request(baseUrl).post('api/v1/admin/category/getDistrictForBlockCategory').set('token', token)
            .send({
                searchValue: "",
                page: 1,
                limit: 2,
