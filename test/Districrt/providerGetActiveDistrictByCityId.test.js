...
describe("Test the provider get active district by city id API", () => {


    it("It should response 200 to the get method", async () => {

        const response = await request(baseUrl).get('api/v1/provider/district/getActiveDistricts/60364ab815b16b414f8e7de5').set('token', token).set('accept-language', 'en')
