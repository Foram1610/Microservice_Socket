...
describe("Test the admin get district by id API", () => {


    it("It should response 200 to the get method", async () => {

        const response = await request(baseUrl).get('api/v1/admin/district/getDistrictById/60388d141467697e676ae374').set('token', token)
