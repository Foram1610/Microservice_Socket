...
describe("Test the provider get active country API", () => {


    it("It should response 200 to the get method", async () => {

        const response = await request(baseUrl).get('api/v1/provider/country/getActiveCountries').set('token', token).set('accept-language', 'en')
