...
describe("Test the provider get region API", () => {


    it("It should response 200 to the POST method", async () => {

        const response = await request(baseUrl).get('api/v1/provider/region/getRegions').set('token', token).set('accept-language', 'en')
            .send()
