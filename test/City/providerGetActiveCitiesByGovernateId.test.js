...
describe("Test the provider get active cities by governate id API", () => {


    it("It should response 200 to the get method", async () => {

        const response = await request(baseUrl).get('api/v1/provider/city/getActivecities/6030ada1a74127eb0670f24d').set('token', token).set('accept-language', 'en')
