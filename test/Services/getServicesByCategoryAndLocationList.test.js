...
const data = [{
    ...
    "categoryId": ["62a5ee7dafdefa76f7b685bc"],
...
describe("Test the admin get services by category and location list API", () => {

    it("It should response 200 to the post method", async () => {

        const response = await request(baseUrl).post('api/v1/admin/service/getServicesByCategoryAndLocationList').set('token', token).send({
            "categoryId": ["62a5ee7dafdefa76f7b685bc"],
            "districtId": ["604207158e169e830cdc37d7"],
            "governateId": ["6030ada1a74127eb0670f24d"],
            "cityId": ["60364ab815b16b414f8e7de5"],
    ...
    test.each(data)("It should response 400 to the POST method", async (singleData) => {
        ...
        const response = await request(baseUrl).post('api/v1/admin/service/getServicesByCategoryAndLocationList').set('token', token)
            .send(singleData)
