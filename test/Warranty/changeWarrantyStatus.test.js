...
describe("Test the warranty status change API", () => {

    it("It should response 200 to the patch method", async () => {

        const response = await request(baseUrl).patch('api/v1/admin/warranty/editWarrantyStatus/6354fcd6cd95ec17f583253f').set('token', token).send({
            "status": "Active"
        })
